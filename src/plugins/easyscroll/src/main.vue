// reference
https://github.com/noeldelgado/gemini-scrollbar/blob/master/index.js
<script>
...
export default {
  ...
  data() {
    return {
      ...
      preScrollHeigt: 0,
      opt: {
        barColor: "rgba(144,147,153,0.3)", //滚动条颜色
        barWidth: 6, //滚动条宽度
        railColor: "transparent", //导轨颜色
        barMarginRight: 2, //垂直滚动条距离整个容器右侧距离单位（px）
